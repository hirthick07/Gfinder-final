...
const stats = [
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-7 w-7" style={{ color: "#2d52cc" }}>
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-7 w-7" style={{ color: "#22c55e" }}>
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-7 w-7" style={{ color: "#f59e0b" }}>
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-7 w-7" style={{ color: "#ec4899" }}>
...
const floatingWords = ["Report", "Search", "Recover", "Match", "connect", "Verify"];
...
const Index = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-white">
      {/* Hero Section */}
      <section className="relative overflow-hidden" style={{ minHeight: 640, marginTop: "-72px" }}>
        ...
        {/* Left-side gradient to make text readable */}
        <div
          style={{
            position: "absolute",
            inset: 0,
            background: "linear-gradient(to right, rgba(15,35,120,0.75) 0%, rgba(15,35,120,0.45) 50%, rgba(15,35,120,0.0) 100%)",
            zIndex: 1,
          }}
        />
        ...
        <svg
          ...
          style={{ zIndex: 3, display: "block", marginBottom: -1 }}
        >
          <path d="M0 15C200 15 260 105 480 105C700 105 740 5 960 5C1180 5 1240 90 1440 90V110H0V15Z" fill="white" />
        </svg>

        <div
          className="container relative mx-auto px-6 flex items-center"
          style={{ zIndex: 2, minHeight: 640, paddingTop: 104, paddingBottom: 110 }}
        >
          <div className="max-w-xl">
            ...
            >
              ...
              <h1 className="mb-5 text-4xl font-bold leading-tight md:text-5xl lg:text-6xl" style={{ color: "#faee1c" }}>
                Lost Something?
                <br />
                You Find It.
              </h1>
              <p className="mb-8 max-w-md text-base text-blue-100 md:text-lg">
                We are the digital lost &amp; found platform for campus users, and
                we value safety and simplicity to connect lost items with their
                rightful owners.
              </p>
      ...
      <section className="w-full px-4 py-12 md:py-16 text-center">
        ...
        <p className="mt-4 mx-auto max-w-lg text-gray-500 text-base md:text-lg">
          GFinder reimagines how you get your belongings back.
          Our platform provides easy-to-use tools for listing, filtering, and
      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          <div className="mb-8 text-center">
            <h2 className="text-3xl font-bold text-blue-600">Recent Listings</h2>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="mb-14 text-center">
            <h2 className="text-3xl font-bold md:text-4xl" style={{ color: "#2d52cc" }}>How it works</h2>
          ...
          >
            ...
            <div className="flex-1 md:pr-8">
              <span className="block text-5xl font-extrabold mb-3" style={{ color: "#2d52cc", lineHeight: 1 }}>01</span>
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Report lost or found items instantly.</h3>
              <p className="text-gray-500 mb-5">Lost something? Found something? Post it in seconds with all important details like location, date, and description. GOFIND makes reporting fast, clear, and organized for everyone.</p>
              <ul className="space-y-2">
                {[
                  ...
                  <li key={feat} className="flex items-start gap-2 text-sm text-gray-600">
                    <svg className="mt-0.5 h-4 w-4 shrink-0" style={{ color: "#2d52cc" }} viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414L8.414 15 3.293 9.879a1 1 0 011.414-1.415L8.414 12.172l6.879-6.879a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    {feat}
                  </li>
                ))}
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-1 mt-1">
                    <svg className="h-3 w-3 text-green-500" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M5.293 9.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 7.414V15a1 1 0 11-2 0V7.414L6.707 9.707a1 1 0 01-1.414 0z" clipRule="evenodd" /></svg>
                    <span className="text-green-600 text-xs">+40% Last month</span>
                  </div>
                </div>
                {/* Earn Points badge */}
                <div
          ...
          >
            ...
            <div className="flex-1 md:pl-8">
              <span className="block text-5xl font-extrabold mb-3" style={{ color: "#2d52cc", lineHeight: 1 }}>02</span>
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Search listings and find perfect matches.</h3>
              <p className="text-gray-500 mb-5">Browse through lost and found posts using filters and keywords. Our smart listing system helps you quickly identify items that match yours.</p>
              <ul className="space-y-2">
                {[
            ...
            <div className="flex-1 relative flex justify-center">
              ...
              >
                ...
                >
                  <p className="font-semibold text-gray-800 mb-0.5">✅ Item Match Found!</p>
          ...
          >
            {/* Text side */}
            <div className="flex-1 md:pr-8">
              <span className="block text-5xl font-extrabold mb-3" style={{ color: "#2d52cc", lineHeight: 1 }}>03</span>
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Connect securely and recover with confidence.</h3>
              <p className="text-gray-500 mb-5">Once you find a matching item, you can contact the person safely through the platform. GOFIND supports privacy-first communication without exposing personal details.</p>
              <ul className="space-y-2">
                {[
